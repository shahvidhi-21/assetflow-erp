    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-tr from-primary-950 via-gray-900 to-indigo-950 p-6">
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-black/40 p-8 shadow-2xl backdrop-blur-xl">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-gray-400">Company Resource & Asset Portal</p>
        </div>
        ...
        {/* Demo Details Hint */}
        <div className="mt-6 rounded-2xl border border-white/5 bg-white/5 p-4 text-xs text-gray-400">
          <p className="font-semibold text-gray-200 mb-1">💡 Demo Admin Account Credentials:</p>
          <p>Email: <code className="text-primary-300 font-mono">admin@assetflow.com</code></p>
          <p>Password: <code className="text-primary-300 font-mono">admin123</code></p>
        </div>
